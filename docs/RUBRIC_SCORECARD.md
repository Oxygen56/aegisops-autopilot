...
| Presentation & Documentation | 15% | Judge quickstart, architecture diagram, visible dashboard rubric-evidence panel, demo script, video pack, Devpost copy, submission audit, reproducible run ledger | `docs/JUDGE_QUICKSTART.md`, `docs/ARCHITECTURE.md`, `src/client/main.tsx`, `docs/DEMO_SCRIPT.md`, `docs/VIDEO_SUBMISSION.md`, `submissions/devpost_fields.md`, `reports/submission_audit.md`, `reports/experiment_board.md` |

...
const items: EvidenceItem[] = [
  ...
  },
  {
    ...
    status: verified(
        ...
        includes("reports/live_qwen_smoke_proof.md", "Status: `verified`")
    ),
    evidence: ["src/server/agent/qwenClient.ts", "reports/live_qwen_smoke_proof.md", "reports/qwen_integration_audit.md", "docs/QWEN_TOOLS.md"],
    proof: "Automated audit verifies endpoint, credentials, offline fallback, live tool-call loop, OpenAPI tools, MCP, and CI coverage; the one-shot live smoke proof verifies qwen-plus without saving a key."
  },
  {
    section: "Stage One Viability",
  ...
  },
  {
    ...
    status: verified(
      includes("package.json", "\"qwen:live-smoke\"") &&
        ...
        includes("reports/live_qwen_smoke_proof.md", "Status: `verified`") &&
        includes("reports/live_qwen_smoke_proof.md", "Provider mode: `qwen-cloud`") &&
        includes("reports/live_qwen_smoke_proof.md", "Qwen tool schemas included: `5`")
    ),
    evidence: ["scripts/liveQwenSmokeProof.ts", "reports/live_qwen_smoke_proof.md", "package.json"],
    proof: "The one-shot smoke proof is verified with qwen-cloud, qwen-plus, five Qwen tool schemas, latency, and redacted credential state; public CI preserves the verified report and never writes the key."
  },
  {
